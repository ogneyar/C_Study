...
#define EEPROM_Address (0x50 << 1) // 0xA0
...
// #define Address_Length   Address_8bit
#define Address_Length   Address_16bit

/* Global define */
#define SIZE sizeof(TEXT_Buffer)

/* Global Variable */
const u8 TEXT_Buffer[]={"CH32V203 I2C TEST"};
...
int main(void)
{
	...
	IIC_Init( 100000, EEPROM_Address );

	printf("Start Write 24Cxx....\r\n");
	AT24CXX_Write(1,(u8*)TEXT_Buffer,SIZE);
	printf("24Cxx Write Sucess!\r\n");

	Delay_Ms(500);

	printf("Start Read 24Cxx....\r\n");
	AT24CXX_Read(1,data,SIZE);
...
#if (Address_Length  == Address_8bit)
	I2C_SendData( I2C2, (u8)(ReadAddr&0x00FF) );
	while( !I2C_CheckEvent( I2C2, I2C_EVENT_MASTER_BYTE_TRANSMITTED ) );

#elif (Address_Length  == Address_16bit)
